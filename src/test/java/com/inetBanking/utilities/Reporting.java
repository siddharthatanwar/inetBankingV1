...
//--------This is aListener class used to generate an Extent report--------//
...
public class Reporting extends TestListenerAdapter
{
	...
	public void onStart(ITestContext testContext)
	{
		...
		String repName="Test-Report-InetBanking"+timeStamp+".html";
		...
		extent.setSystemInfo("user","Siddharth Singh");
